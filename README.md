...
**Eleven ways to turn `"-2 ^ 2 + 3 * (4 - 1)"` into `14` — benchmarked head-to-head.**
...
Requires GCC 14 + CMake ≥ 3.20. No external dependencies.
...
tests/            test_parsers.cpp (267 checks, run via CTest)
```
